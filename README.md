...
```
  2. Подключите/создайте Telegram credentials с токеном вашего бота, запустите и попробуйте допустим отправить видео, ОБЯЗАТЕЛЬНО С ПОДПИСЬЮ /2gif, аналогично можно сконвекрировать .docx документ в .pdf прикрепив его с командой /2pdf.
## Поздравляю теперь ваш N8N имеет в себе libreoffice и ffmpeg, которые можно использовать для конвертации большого числа медиа и документов.
